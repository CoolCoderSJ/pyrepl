...
setup(
  name = 'pyrepl',         # How you named your package folder (MyLib)
  packages = ['pyrepl'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/CoolCoderSJ/pyrepl/archive/v_01.tar.gz',    # I explain this later on
